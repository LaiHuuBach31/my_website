...
<body>
    ...
    <main>
        ...
        <div class="alert alert-success" role="alert">
            <strong class="text-center">{{Session::get('yes')}}</strong>
        </div>
        @endif
        @if(Session::has('no'))
        <div class="alert alert-danger" role="alert">
            <strong class="text-center">{{Session::get('no')}}</strong>
        </div>
        @endif
        <div class="container" style="padding: 50px 0px;">
            ...
            <div class="col-lg-5" style="margin: 0 auto;">
                <h4 class="mb-5 text-center" style="font-weight: 650;">Create New Customer Account</h4>
                <form action="{{route('index.register')}}" method="post">
                    ...
                    <button type="submit" class="btn btn-primary" style="font-weight: 700;">Register</button>
                </form>
            </div>
        </div>
    </main>
