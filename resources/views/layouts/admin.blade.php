...
<head>
    ...
    <!-- css admin -->
    <link rel="stylesheet" href="{{url('')}}/css/admin/attribute.css">
    <link rel="stylesheet" href="{{url('')}}/css/admin/user.css">
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="../../index2.html" class="logo">
                ...
                <span class="logo-lg"><b>Your</b>Admin</span>
            </a>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-left">
                                        <a href="{{route('admin.change_password')}}" class="btn btn-default btn-flat">ChangePassword</a>
                                    </div>
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{route('product.discount')}}"><i class="fa fa-circle-o"></i>  Discount Product</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-table"></i> <span>Image</span>
                            <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <li><a href="{{route('image.index')}}"><i class="fa fa-circle-o"></i> List Image</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-table"></i> <span>Attribute</span>
                            <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <li><a href="{{route('attribute.index')}}"><i class="fa fa-circle-o"></i> List Attribute</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{route('role.index')}}"><i class="fa fa-circle-o"></i> List Role</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
    ...
    <!-- js admin -->
    <script src="{{url('')}}/js/admin/attribute.js"></script>
    <script src="{{url('')}}/js/admin/image.js"></script>
    <script src="{{url('')}}/js/admin/product.js"></script>
    <script src="{{url('')}}/js/admin/user.js"></script>
    <script src="{{url('')}}/js/admin/role.js"></script>
</body>
