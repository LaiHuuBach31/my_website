...
@section('main')
<div class="container">
    <h1 class="text-center">List Attribute</h1>
    <table class="table table-bordered text-center">
        <form action="" method="get">
            <div class="form-group form-inline">
                <input type="text" name="keyword" class="form-control" placeholder="Search........." style="width:300px">
                <button type="submit" class="btn btn-primary"><i class="fa fa-search" aria-hidden="true"></i></button>
                <a href="{{route('attribute.create')}}" class="btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Add new</a>
            </div>
        </form>
        <thead>
            <tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{route('attribute.edit' , $item->id)}}" class="btn btn-primary"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                    ...
                                    <div>
                                        ...
                                        <form action="{{ route('attribute.destroy', $item->id) }}" method="post">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-danger">Yes, Delete Attribute</button>
                                            </div>
                                        </form>
